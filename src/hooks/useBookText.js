...
const CACHE_PREFIX    = 'bunko_html_v12_'; // HTML形式キャッシュ（v12: ruby→<span class=rw>に完全変換、display:inlineで文字サイズ問題解消）
...
(()=>{
  try {
    Object.keys(localStorage)
      .filter(k => ['bunko_text_','bunko_html_v1_','bunko_html_v2_','bunko_html_v3_','bunko_html_v4_','bunko_html_v5_','bunko_html_v6_','bunko_html_v7_','bunko_html_v8_','bunko_html_v9_','bunko_html_v10_','bunko_html_v11_'].some(p => k.startsWith(p)))
