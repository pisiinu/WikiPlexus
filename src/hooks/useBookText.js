...
const CACHE_PREFIX    = 'bunko_html_v20_'; // HTML形式キャッシュ（v20: rt 0.75em、jisage height:100%で列高確定、content div height:100%）
