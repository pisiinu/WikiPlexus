...
const CACHE_PREFIX    = 'bunko_html_v6_';  // HTML形式キャッシュ（v6: rp除去を廃止→CSS display:none）
...
(()=>{
  try {
    Object.keys(localStorage)
      .filter(k => ['bunko_text_','bunko_html_v1_','bunko_html_v2_','bunko_html_v3_','bunko_html_v4_','bunko_html_v5_'].some(p => k.startsWith(p)))
