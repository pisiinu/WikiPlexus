...
const CACHE_PREFIX    = 'bunko_html_v5_';  // HTML形式キャッシュ（v5: rp除去のみ・rb保持）
...
(()=>{
  try {
    Object.keys(localStorage)
      .filter(k => ['bunko_text_','bunko_html_v1_','bunko_html_v2_','bunko_html_v3_','bunko_html_v4_'].some(p => k.startsWith(p)))
