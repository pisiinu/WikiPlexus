...
const CACHE_PREFIX    = 'bunko_html_v7_';  // HTML形式キャッシュ（v7: gaiji span wrapper, rb除去, sesame_dot CSS）
...
(()=>{
  try {
    Object.keys(localStorage)
      .filter(k => ['bunko_text_','bunko_html_v1_','bunko_html_v2_','bunko_html_v3_','bunko_html_v4_','bunko_html_v5_','bunko_html_v6_'].some(p => k.startsWith(p)))
