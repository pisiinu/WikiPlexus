...
const CACHE_PREFIX    = 'bunko_html_v27_'; // HTML形式キャッシュ（v27: .ra=ゼロ幅inline-blockアンカーでベース文字レンダリングを保持しつつ含有ブロックを確保）
