  ...
  return (
    <div style={{position:"fixed",inset:0,background:"linear-gradient(150deg,#f7f2e8 0%,#ece6d4 100%)",fontFamily:"'Noto Serif JP','Yu Mincho',serif",userSelect:"none"}}>
      <style>{`
        ...
        .rw{display:inline;transform:translate(0)}
        .rt{position:absolute;writing-mode:vertical-rl;right:-0.5em;top:0;font-size:0.75em;line-height:1;white-space:nowrap}
